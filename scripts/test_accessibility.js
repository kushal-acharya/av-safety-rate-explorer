...
try {
  for(const tab of ['rates','compare','planner','methods','replication','geography','geography#geo-reading-guide']) {
  ...
  console.log('All six views and the expanded reading guide pass the automated WCAG A/AA scan.');
