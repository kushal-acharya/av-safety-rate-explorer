...
function renderEventContext() {
  mountEventContext($('event-context'), { data, annualRows: selectedRows(), dimension: state.context, confidence: state.confidence, unit: state.unit, onDimension: dimension => { state.context = dimension; updateURL(); renderEventContext(); $('context-dimension').focus(); } });
}
function exportCSV() {
